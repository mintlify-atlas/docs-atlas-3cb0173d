...
<ResponseField name="return" type="t_drop *">
...
<ResponseField name="prev_item" type="t_item *">
  Previous item reference for state management
</ResponseField>

<ResponseField name="auto_use" type="bool">
  Whether the item is automatically used when picked up
</ResponseField>

<ResponseField name="auto_pickup" type="bool">
